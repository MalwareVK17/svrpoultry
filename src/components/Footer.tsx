          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center">
                <img src="https://www.adm.com/globalassets/products--services/animal-nutrition/species/poultry/poultry_c30_us_l.png" alt="Poultry" className="w-3 h-3 object-contain" />
              </div>
